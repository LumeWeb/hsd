...
main.names = {
  ...
  /**
   * HARD FORK
   * The extended time window in which some
   * nameholders can claim reserved names.
   * @const {Number}
   */

  extendedClaimPeriod: (8 * 365) * main.pow.blocksPerDay,
...
// main.names.claimPeriod + 1
// (claimPeriod + 1) % treeInterval === 1
main.thumbwrestleActivationHeight = 210241;
...
testnet.names = {
  ...
  extendedClaimPeriod: 180 * testnet.pow.blocksPerDay,
...
// testnet.names.claimPeriod + 1
// (claimPeriod + 1) % treeInterval === 1
testnet.thumbwrestleActivationHeight = 12961;
...
regtest.thumbwrestleActivationHeight = Infinity;
...
// simnet.names.claimPeriod + 1
// (claimPeriod + 1) % treeInterval === 1
simnet.thumbwrestleActivationHeight = 201;
